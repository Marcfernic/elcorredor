...
urlpatterns += [
    ...
    url(r'^property/unverify/$', views.UnverifyProperty.as_view(), name = 'unverify_property'),
    url(r'^property/verified/$', views.PropertyVerified.as_view(), name = 'property_verified'),
    url(r'^property/unverified/$', views.PropertyUnverified.as_view(), name = 'property_unverified'),
